<template>
    <div class="layout--main" :class="[navbarClasses, footerClasses, {'app-page': isAppPage}]"> 
        ...
        <vx-sidebar v-if="userType=='Admin'"  :sidebarItems="sidebarItemsForAdmin" 
            :logo="!this.$store.state.reduceButton?require('@/assets/images/icons/optifood_logo.png'):require('@/assets/images/logo/logo.png')" 
            title="Optifood" 
            parent=".layout--main" />
        <vx-sidebar v-else 
...
import sidebarItemsForAdmin from "@/layouts/components/vx-sidebar/sidebarItemsForAdmin.js";
...
export default {
    data() {
        return {
            ...
            sidebarItems: sidebarItems,
            sidebarItemsForAdmin: sidebarItemsForAdmin,
