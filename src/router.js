  ...
  routes: [
    {
      ...
      children: [
...

        {
          ...
          name: "viewRestaurant",
          component: () =>
            import("./views/pages/restaurant/viewRestaurant.vue"),
          meta: {
            rule: "editor",
          },
        },
...

        {
          ...
          name: "viewMacAddress",
          component: () =>
            import("./views/pages/macAddress/viewMacAddress.vue"),
          meta: {
            rule: "editor",
          },
        },
...

        {
          ...
          name: "editMacaddress",
          component: () =>
            import("./views/pages/macAddress/editMacAddress.vue"),
          meta: {
            rule: "editor",
          },
        },

        {
          ...
          component: () =>
            import("@/views/pages/restaurant/registerRestaurant.vue"),
          meta: {
            rule: "editor",
          },
        },

        {
          ...
          name: "editRestaurant",
          component: () =>
            import("@/views/pages/restaurant/editRestaurant.vue"),
          meta: {
            rule: "editor",
          },
        },
...

        {
          ...
          component: () =>
            import("@/views/pages/Permission/fetch-roles-for-permission.vue"),
          meta: {
            rule: "editor",
          },
        },
        {
          ...
          component: () =>
            import("@/views/pages/Permission/assignPermission.vue"),
          meta: {
            rule: "editor",
          },
        },
...

        {
          ...
          name: "permissions",
          component: () =>
            import("./views/pages/Permission/assignPermission1.vue"),
          meta: {
            rule: "editor",
          },
        },

        {
          ...
          name: "roleAssign",
          component: () =>
            import("./views/pages/AssignRoleToUser/assignRoles.vue"),
          meta: {
            rule: "editor",
          },
        },
