        ...
        <template slot-scope="{ data }">
          <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
            ...
            <vs-td class="pr-4 w-1/6" :data="data[indextr].name"
              >{{ data[indextr].name }} {{ data[indextr].firstName }}</vs-td
            >
            <vs-td class="pr-4 w-1/6" :data="data[indextr].name"
              >{{ data[indextr].name }} {{ data[indextr].firstName }}</vs-td
            >
            ...
            <vs-td class="pr-4 w-1/6" :data="data[indextr].name"
              >{{ data[indextr].name }} {{ data[indextr].firstName }}</vs-td
            >
            <vs-td class="pr-4 w-1/8" :data="data[indextr].name"
              >{{ data[indextr].name }} {{ data[indextr].firstName }}</vs-td
            >
            <vs-td class="pr-4 w-1/8" :data="data[indextr].email">{{
              data[indextr].email
            }}</vs-td>
            <vs-td class="pr-4 w-1/6" :data="data[indextr].phoneNumber">{{
              data[indextr].phoneNumber
            }}</vs-td>
            <vs-td class="p-0 pr-4 w-1/4" :data="data[indextr].id">
              <span
                v-if="isGranted('editCountry')"
                @click="updateCountry(data[indextr].countryId)"
              >
                <vs-avatar
                  color="lightGreen"
                  icon-pack="feather"
