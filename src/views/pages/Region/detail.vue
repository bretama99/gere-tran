    ...
    <vx-card id="internal-card" no-shadow card-border>
      ...
      >
        <template>
          <vs-tr>
            <vs-td
              class="pr-4 w-1/4">{{$t('countryName')}}</vs-td>
            <vs-td class="p-0">{{item.name}}</vs-td>
          </vs-tr>
           <vs-tr>
            <vs-td
              class="pr-4 w-1/4">{{$t('nationality')}}</vs-td>
            <vs-td class="p-0">{{item.nationalityName}}</vs-td>
          </vs-tr>
        </template>
      </vs-table>
    </vx-card>
...
export default {
  ...
  methods: {
    ...
    openConfirm(status, Country, color) {
      this.status[0] = true;
      if (status == true) {
        this.countryStatus = "Disabled";
