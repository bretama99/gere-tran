...
export default {
    ...
    render(h, {props, data}) {
        ...
        let badgeEl = h('span', {class: 'feather-icon-badge bg-danger text-white h-5 w-5 absolute rounded-full text-xs flex items-center justify-center', style: 'top: -7px; right: -5px'}, [props.badge])
        let children = [svg]
